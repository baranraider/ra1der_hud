...
AddEventHandler('esx_basicneeds:resetStatus', function()
	TriggerEvent('esx_status:set', 'hunger', 50)
	TriggerEvent('esx_status:set', 'thirst', 50)
...
AddEventHandler('esx_basicneeds:onEat', function(name,prop_name, posx, posy, posz, rotx, roty, rotz)
...
function chat()
    TriggerEvent('chat:addMessage', {
        template = '<div class="chat-message nonemergency">[UYARI] : Acıktın, birşeyler yemelisin! </div>',
        multiline = true,
        args = {"", ""}
    })
end
...
function chat2()
    TriggerEvent('chat:addMessage', {
        template = '<div class="chat-message nonemergency">[UYARI] : Susadın, birşeyler içmelisin! </div>',
        multiline = true,
        args = {"", ""}
    })
end
